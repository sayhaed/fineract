...
public class SavingsWithTaxIntegrationTest {
    ...
    /**
     * This test verifies the complete flow of creating tax components,
     * a tax group that contains them, and the subsequent creation of a savings
     * product that uses that tax group.
     */
    @Test
    public void shouldCreateTwoTaxComponentsAndATaxGroupWithBothSuccessfully() {
        ...
        final Integer savingsProductID = createSavingsProductWithAccrualAccountingWithOutOverdraftAllowed(taxGroupId,liabilityAccount,expenseAccount,incomeAccount,assetAccount, savingsControlAccount);
    ...
    public Integer createSavingsProductWithAccrualAccountingWithOutOverdraftAllowed(Integer taxGroupId, final Account... accounts) {
        ...
        this.productHelper = new SavingsProductHelper().withInterestCompoundingPeriodTypeAsAnnually()
                ...
                .withWithHoldTax(taxGroupId.toString());
